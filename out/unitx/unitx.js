...
class Unitx {
    ...
    getPullUnitxApi(unit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (prev === undefined)
                return current;
            // 小于10分钟
            if (Date.now() - prev.tickCreate < 60 * 10 * 1000) {
                // 用老的unitx拉
                return prev;
            }
            else {
    ...
    buildUnitxApiBox(unit) {
        return __awaiter(this, void 0, void 0, function* () {
            let unitxUrls = yield core_1.centerApi.unitx(unit);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (core_1.env.isDevelopment === true) {
                if (server === this._db.serverId) {
                    let urlDebug = yield core_1.getUrlDebug();
    ...
    pullBus(unit, maxId, faces) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ret === undefined) {
                console.error('undefined return from await openApi.fetchBus; unit=%s, url=%s', unit, unitxApi.url);
                return;
            }
        });
    }
...
class UnitxProd extends Unitx {
    buildUnitxDb() {
        let dbName = core_1.consts.$unitx;
        this._db = new core_1.UnitxProdDb(dbName);
    }
...
class UnitxTest extends Unitx {
    buildUnitxDb() {
        let dbName = core_1.consts.$unitx + '$test';
        this._db = new core_1.UnitxTestDb(dbName);
    }
